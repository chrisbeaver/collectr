                ...
                <nav class="nav">
                    <div class="container">
                        ...
                        <div class="nav-right nav-menu">
                            ...
                            <span class="nav-item">
                                <a class="button is-default">Get Early Access</a>
                            </span>
                        </div>
                    </div>
                </nav>
            ...
            <div class="container has-text-centered">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-6 is-offset-1">
                        <h1 class="title is-2">Introducing Landing Page</h1>
                        <h2 class="subtitle is-4">It's time to say hello to bulma.</h2>
                        <br />
                        <p class="control has-addons has-text-centered">
                            <form action="{{ action('CampaignController@saveEmailAddress', $campaign) }}" method="POST">
                                {{ csrf_field() }}
                                <input class="input is-expanded is-large" name="email" type="text" placeholder="Join the beta waitlist, you@example.org">
                                <button type="submit" class="button is-large is-danger is-outlined">Sign Up</a>
                            </button>
                        </p>
                    </div>
                </div>
